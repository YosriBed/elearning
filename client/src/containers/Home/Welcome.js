      ...
      <div className="lg:w-2/3 mx-auto">
        <div className="flex flex-wrap w-full bg-gray-800 py-32 px-10 relative mb-4">
          ...
          <div className="text-center relative z-10 w-full">
            ...
            <p className="leading-relaxed">Continue as a Student</p>
          </div>
        </div>
          ...
          <div className="px-2 w-1/2">
            <div className="flex flex-wrap w-full bg-gray-800 sm:py-24 py-16 sm:px-10 px-6 relative">
              ...
              <div className="text-center relative z-10 w-full">
                ...
                <p className="leading-relaxed">Continue as a teacher</p>
              </div>
            </div>
          </div>
          <div className="px-2 w-1/2">
            <div className="flex flex-wrap w-full bg-gray-800 sm:py-24 py-16 sm:px-10 px-6 relative">
              ...
              <div className="text-center relative z-10 w-full">
                ...
                <p className="leading-relaxed">Continue as Administrator</p>
              </div>
            </div>
          </div>
        </div>
